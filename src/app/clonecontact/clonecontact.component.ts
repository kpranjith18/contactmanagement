...
@Component({
  selector: 'app-clonecontact',
  templateUrl: './clonecontact.component.html',
  styleUrls: ['./clonecontact.component.scss']
})
export class ClonecontactComponent implements OnInit {
  id: any;
  contactform: any={};
  contactdetails: any={};
